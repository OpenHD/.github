...
2+|image:https://opencollective.com/openhd/tiers/backer.svg[height=50, link="#"]
2+|+++<p align="center"><img height="50" src="hhttps://opencollective.com/openhd/tiers/backer.svg" alt="Bakers"></p>+++

...
|=======================================================================
|Financial contributors | Donations

image:https://opencollective.com/openhd/tiers/badge.svg[] | 
++++
link:https://opencollective.com/openhd/donate[link=https://opencollective.com/openhd/donate]image:https://opencollective.com/openhd/donate/button.png[Donate,role="button",width="200px"]link:end[]
++++
|=======================================================================
